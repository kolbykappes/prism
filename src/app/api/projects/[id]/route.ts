...
export async function GET(
  ...
  try {
    ...
    return errorResponse("Failed to fetch project", 500, error instanceof Error ? error.message : "Unknown error");
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return errorResponse("Failed to update project", 500, error instanceof Error ? error.message : "Unknown error");
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return errorResponse("Failed to delete project", 500, error instanceof Error ? error.message : "Unknown error");
  }
}
